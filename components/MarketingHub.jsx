...
const DEFAULT_INITIATIVES = [
  ...
  {id:"init-bb-reposition", title:"Bubbles Repositioning Statement", description:"Strategic repositioning of Bubbles from 'tasty vape flavors' to 'the culture of flavor chasing.' Reframes Bubbles as a lifestyle brand built around sensory experience, urban nightlife energy, and nostalgic summer aesthetics. Covers new positioning, brand personality, elevated flavor copy, cultural values, audience sharpening, and contrast with Safe Bet.", owner:"Brand Team", channel:"06 · Social Media Strategy", startDate:"2026-04-01", endDate:"", revolving:true, fileUrl:null, fileName:null, _brief:null, brandId:"bubbles", htmlConcept:null, htmlConceptName:"Bubbles Repositioning Statement", _conceptUrl:null},
];
    ...
    (async () => {
      ...
      try {
        ...
        if (i) {
          ...
          const RESTORE_IDS = ["init-email-sms","init-hc-sesh","init-sb-float","init-bb-reposition"];
